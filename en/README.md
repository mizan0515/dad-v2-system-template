...
3. Read `.prompts/07-existing-project-migration.md` before introducing DAD v2 into an existing repository.
4. Use `.prompts/08-template-review-hardening.md` when you want Claude Code to review and harden the template repository itself.
5. Keep `.prompts/09-emergency-session-recovery.md` available for force-close, manual state repair, or validator-outage recovery.
